...
@interface IRCameraSlideView () <IRCameraSlideViewProtocol>
...
@implementation IRCameraSlideView

static NSString* const kExceptionName = @"IRCameraSlideViewException";
static NSString* const kExceptionMessage = @"Invoked abstract method";

#pragma mark -
#pragma mark - Public methods

+ (void)showSlideUpView:(IRCameraSlideView *)slideUpView slideDownView:(IRCameraSlideView *)slideDownView atView:(UIView *)view completion:(void (^)(void))completion
{
...
+ (void)hideSlideUpView:(IRCameraSlideView *)slideUpView slideDownView:(IRCameraSlideView *)slideDownView atView:(UIView *)view completion:(void (^)(void))completion
{
